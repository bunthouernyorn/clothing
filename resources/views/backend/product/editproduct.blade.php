                        ...
                        <div class="row" style="margin-bottom:40px">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input  type="text" name="product_code" class="form-control" value="SP01">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input  type="text" name="product_name" class="form-control" value="Sản phẩm 1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input  type="number" name="product_price" class="form-control" value="150000">
